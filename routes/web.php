...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'solutions'], function() {
        Route::get('/create', 'Admin\SolutionController@create')->name('solutions.create');
        Route::post('/', 'Admin\SolutionController@store')->name('solutions.store');
        Route::post('/{id}/update', 'Admin\SolutionController@update')->name('solutions.update');
        Route::get('/{id}/edit', 'Admin\SolutionController@edit')->name('solutions.edit');
        Route::get('/{id}/delete', 'Admin\SolutionController@delete')->name('solutions.delete');
        Route::get('/', 'Admin\SolutionController@index')->name('solutions.index');
        Route::get('/searchData', 'Admin\SolutionController@searchData')->name('solutions.searchData');
        Route::post('/nested-sort', 'Admin\SolutionController@nestedSort')->name('solutions.nestedSort');
        Route::get('/{id}/getDataForEdit', 'Admin\SolutionController@getDataForEdit')->name('solutions.get.data.edit');
        Route::post('add-to-home-page', 'Admin\SolutionController@addToHomePage')->name('solutions.add.homepage');
        Route::get('/get-parent', 'Admin\SolutionController@getParentCategory')->name('solutions.get.parent');
    });
