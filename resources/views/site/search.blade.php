            ...
            <div class="e-con-inner">
                <div
                    ...
                    <div class="elementor-widget-container">
                        <h1 class="elementor-heading-title elementor-size-default">Tìm kiếm sản phẩm</h1></div>
                </div>
                <div
                    ...
                    <div class="elementor-widget-container">
                        <nav class="woocommerce-breadcrumb" aria-label="Breadcrumb">Có {{ $products->count() }} kết quả phù hợp với từ khóa "{{ $keyword }}"
                        </nav>
                    </div>
                </div>
            </div>
                            ...
                            <div class="elementor-widget-container">
                                <div class="elementor-shortcode">
                                    <ul class="subcategories-list">
                                        @foreach($allCates as $child)
                                            <li><a href="{{ route('front.getChildCategory', $child->slug) }}">{{ $child->name }}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
