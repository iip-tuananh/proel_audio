...
@section('title')Giải pháp -  {{ $config->web_title }}@endsection
...
@section('content')
    ...
    <div data-elementor-type="product-archive" data-elementor-id="8291"
        ...
        <div class="elementor-element elementor-element-031b016 e-flex e-con-boxed e-con e-parent" data-id="031b016"
             ...
             style="background-image: url({{ $solution->banner->path ?? '' }})"
        >
            <div class="e-con-inner">
                ...
                <div
                    ...
                    <div class="elementor-widget-container">
                        <nav class="woocommerce-breadcrumb" aria-label="Breadcrumb"><a href="{{ route('front.home-page') }}">Trang chủ</a>&nbsp;&#47;&nbsp;&nbsp;{{ $solution->name }}
                        </nav>
                    </div>
                </div>
            </div>
                                ...
                                <div class="elementor-shortcode">
                                    <ul class="subcategories-list">
                                        @foreach($solutions as $s)
                                            <li><a href="{{ route('front.solutions', $s->slug) }}">{{ $s->name }}</a></li>
