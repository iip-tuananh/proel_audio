...
|| request()->is('admin/categories') || request()->is('admin/categories*') || request()->is('admin/solutions*') || request()->is('admin/category-special') ? 'menu-open' : '' }} ">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('solutions.index') }}" class="nav-link {{ Request::routeIs('solutions.index') ? 'active' : '' }}">
                            <i class="far fas  fa-angle-right nav-icon"></i>
                            <p>Danh sách danh mục giải pháp</p>
                        </a>
                    </li>
                    <li class="nav-item">
